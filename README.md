I made this project because the platform that I use to purchase stocks has the functionality to purchase a fraction
...
Base Version: The base version provides the user with the interface to enter a stock ticker, what time frame they want to be
the intial cost basis, specify the percentage up or down from that basis and then the total dollar amount desired for the order.
